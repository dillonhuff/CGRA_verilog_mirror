...
//	
//
//  Source file: /horowitz/users/dhuff/CGRAGenerator/hardware/generator_z/jtag/Template/src/digital/tap.svp
//  Source template: tap
//
...
module tap_unq1
  (
   ...
   // Special TDOs
   input logic 	sc_cfg_data_tdo, // serial data out from DATA register sc_cfg_data
   input logic 	sc_cfg_inst_tdo, // serial data out from DATA register sc_cfg_inst
   input logic 	sc_cfg_addr_tdo, // serial data out from DATA register sc_cfg_addr
